 ...
 */
@Service
public class FabricLandService extends AbstractFabricService<FabricLandObject> implements IFabricCommonService<FabricLandObject> {
     ...
     */
    @Autowired
    public FabricLandService(FabricContext fabricContext) {
        super(fabricContext);
    }
    ...
    public FabricLandObject extGet(String key, String type) {
    ...
    public FabricQueryResponse<FabricLandObject> get(String key, String type) {
        if (key == null) {
